...
<div class="login-bg access-offline"></div>

<div class="container login-area error-page offline">
  <div class="section">
    <div class="row center">

              <h3 class="welcome-tagline white-text center">Contact Us</h3>
        <div class="spacer"></div>
      
                <h1 class="white-text center error-code">Contact Us</h1>
      
      
      <div class="spacer"></div>
      <h6 class="white-text center">This page is under cunstruction, We will back soon</h6>
      <div class="spacer"></div>
      <div class="spacer"></div>
          </div>
