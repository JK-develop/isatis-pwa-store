...
<div class="container over">
    <div class="section ">
      <div class="row ">
                <div class="col s12 pad-0"><h5 class="bot-20 sec-tit  ">Categories</h5>
                    ...
                    $cat_icon = $row["image"];
                            ...
                            $statementListApps = $connect->prepare(
                                "SELECT a.title, a.license, a.logo, a.buy_url
                                 ...
                                 JOIN applications a ON ac.application_id = a.id WHERE a.status = 'active' AND ac.category_id = :cat_id"
                            );
                            // Bind the parameter
    ...
    <div class="icon-block block-small circle">
      <div class="icon  primary-text"><img src="'.htmlspecialchars($app["logo"]).'" alt="Icon" style="width: 50px; height: 50px;border-radius: 50%; object-fit: cover;"></div>
 ...
 '.$resultApp.'
            ...
            ';
                        ...
                        echo '<li class="collection-item">
                                      <a href="#" class="waves-effect"><i class="mdi mdi-table "></i><span>No category defined</span><i class="arrow mdi mdi-chevron-right"></i></a>
                                  </li>';
                    }
                } catch(PDOException $error) {  
                    $message = $error->getMessage();  
