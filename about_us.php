...
<div class="container login-area">
    <div class="row" style="position: relative;">
      ...
      <h1 class="white-text center welcome-logo"><svg id="Isatis" data-name="Isatis-Logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380.82 380.82"><defs><style>.cls-1{fill:#ca9e67;}.cls-2{fill:#00a554;}.cls-3{fill:#93c460;}.cls-4{fill:#f1b425;}.cls-5{fill:#fcea10;}.cls-6{fill:#e94976;}.cls-7{fill:#f29abd;}.cls-8{fill:#2da7d5;}.cls-9{fill:#a3d9ea;}</style></defs><polygon class="cls-2" points="285.62 240.78 190.41 190.42 240.77 95.21 335.99 145.57 285.62 240.78 285.62 240.78"/><polygon class="cls-3" points="380.82 291.17 335.99 145.57 190.41 190.42 285.62 240.78 380.82 291.17 380.82 291.17"/><polygon class="cls-4" points="140.04 285.62 190.41 190.42 285.62 240.78 235.25 336 140.04 285.62 140.04 285.62"/><polygon class="cls-5" points="89.67 380.83 235.25 336 190.41 190.42 140.04 285.62 89.67 380.83 89.67 380.83"/><polygon class="cls-6" points="95.2 140.05 190.41 190.42 140.04 285.62 44.83 235.26 95.2 140.05 95.2 140.05"/><polygon class="cls-7" points="0 89.67 44.83 235.26 190.41 190.42 95.2 140.05 0 89.67 0 89.67"/><polygon class="cls-8" points="240.77 95.21 190.41 190.42 95.2 140.05 145.58 44.85 240.77 95.21 240.77 95.21"/><polygon class="cls-9" points="291.16 0 145.58 44.85 190.41 190.42 240.77 95.21 291.16 0 291.16 0"/></svg>About Us</h1>

        <div>
            <section>
            <h2>Who We Are</h2>
            <p>Welcome to Isatis PWA Store, the ultimate platform for discovering and managing Progressive Web Applications (PWAs). Our mission is to simplify access to online services by providing a centralized space for users to store and use PWAs effortlessly.</p>
            </section>

            <section>
                <h2>Our Mission and Vision</h2>
                <p>We believe in a future where users can access a wide range of services without the hassle of installing countless native applications. Our mission is to make PWAs accessible to everyone and reduce app clutter. Our vision is to become the leading platform for PWA discovery and usage worldwide.</p>
            </section>

            <section>
                <h2>The Problem We Solve</h2>
                <p>In today’s digital world, users often find themselves overwhelmed with apps they rarely use, taking up valuable storage space and complicating their digital lives. At Isatis PWA Store, we solve this problem by enabling users to access the services they need through PWAs, offering a seamless and lightweight alternative to traditional apps.</p>
            </section>

            <section>
                <h2>Our Features</h2>
                <ul>
                    <li><strong>PWA Registration:</strong> Easily register and manage your own PWAs.</li>
                    <li><strong>Discover Popular PWAs:</strong> Explore a curated list of PWAs across various industries.</li>
                    <li><strong>User-Friendly Interface:</strong> Enjoy a clean and intuitive design for seamless navigation.</li>
                </ul>
                <p>With these features, we aim to provide a convenient and efficient experience for our users.</p>
            </section>

            <section>
                <h2>Why Choose Isatis PWA Store?</h2>
                <ul>
                    <li>Save storage space on your devices.</li>
                    <li>Access a wide range of services in one place.</li>
                    <li>Reduce app clutter and simplify your digital life.</li>
                </ul>
            </section>

            <section>
                <h2>Future Plans</h2>
                <p>We are constantly working to enhance our platform. In the near future, we plan to introduce advanced search capabilities, mobile optimization, and new integrations to make your experience even better.</p>
            </section>

            <section>
                <h2>Join Us</h2>
                <p>We invite you to join our growing community of PWA enthusiasts. Sign up today, register your PWAs, and explore the endless possibilities of Progressive Web Applications.</p>
            </section>
        </div>
    </div>
