...
if ($id > 0) {
  ...
  $stmt = $connect->prepare("SELECT * FROM applications WHERE id = :id");
  $stmt->execute([':id' => $id]);
...
<div class="content-area">
  ...
  <div class="container has-pagehead is-pagetitle">
    <div class="section">
      <h5 class="pagetitle"><?php echo $app_title ?></h5>
          </div>
  </div>
...
<div class="row ui-mediabox  prods      " >
  ...
  <div class="col s12 ">
        <div class="prod-img-wrap">
            ...
            <a class="img-wrap" href="<?php echo $app_url ?>" data-fancybox="images"
        data-caption="Create Designs that sell">
        <img alt="image" class="" style="width: 100%;" src="<?php echo $app_banner ?>">
      </a>
      ...
      <a href="#" >      <h5 class="title truncate"><?php echo $app_title ?></h5>
      </a>              <span class="small brand"><?php echo $app_title ?></span>
                  <div class="spacer-line"></div>
        <span class="addtocart btn-small"><a style="color: #ffffff" href="<?php echo $app_url ?>" target="_blank">Install</a></span>

        
      
      <div class="spacer-line"></div>
      
        <p class="bot-0 text"><?php echo $app_description ?></p>
...
<div class="footer-menu circular">
  <ul>
      ...
      <span></span>
        ...
        <li >
      <a href="#" >      <i class="mdi mdi-file-tree"></i>
